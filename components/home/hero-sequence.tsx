  ...
  return (
    <section ref={containerRef} className="relative h-[320vh] w-full bg-[#070A10]">
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        >
          <div className="inline-flex items-center rounded-full border border-[#D4AF37]/50 bg-black/75 px-5 py-1.5 shadow-2xl backdrop-blur-md">
            <span className="text-xs font-bold uppercase tracking-[0.25em] text-[#FDE68A]">
              Nabil Rental Padang
            </span>
          </div>

          <h1 className="mt-6 max-w-4xl text-3xl font-black tracking-tight text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.95)] sm:text-5xl md:text-6xl lg:text-7xl">
          ...
          <div className="mt-4 max-w-2xl rounded-2xl border border-white/20 bg-black/65 px-6 py-4 shadow-2xl backdrop-blur-md">
          ...
          <div className="pointer-events-auto mt-8 flex flex-col items-center gap-3">
            <button
              onClick={scrollToFleet}
              className="inline-flex h-12 min-w-[210px] items-center justify-center rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#AA7C11] px-6 text-sm font-bold text-[#0F172A] shadow-xl shadow-[#D4AF37]/30 transition-all hover:brightness-110 active:scale-95"
            >
              Lihat Armada Mobil
            </button>

            <div className="mt-3 flex flex-col items-center gap-1 rounded-full border border-white/10 bg-black/60 px-4 py-1.5 backdrop-blur-md">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-black/80 px-4 py-1.5 shadow-2xl backdrop-blur-md">
          ...
          <h2 className="mt-5 max-w-3xl text-2xl font-black tracking-tight text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.95)] sm:text-4xl md:text-5xl">
            Tangguh Menembus Tanjakan Sitinjau Lauik &amp; Kelok 44
          </h2>

          <div className="mt-3 max-w-xl rounded-2xl border border-white/20 bg-black/70 px-6 py-3.5 shadow-2xl backdrop-blur-md">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div className="rounded-xl border border-white/20 bg-black/85 px-5 py-3.5 shadow-xl backdrop-blur-md">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/50 bg-black/80 px-4 py-1.5 shadow-2xl backdrop-blur-md">
          ...
          <h2 className="mt-5 max-w-2xl text-2xl font-black tracking-tight text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.95)] sm:text-4xl md:text-5xl">
            Tentukan Armada Pilihan Anda
          </h2>

          <div className="mt-3 max-w-lg rounded-2xl border border-white/20 bg-black/70 px-6 py-3.5 shadow-2xl backdrop-blur-md">
            <p className="text-xs font-medium leading-relaxed text-white sm:text-sm md:text-base">
          ...
          <div className="pointer-events-auto mt-6">
            <button
              onClick={scrollToFleet}
              className="inline-flex h-12 items-center gap-2 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#AA7C11] px-6 text-sm font-bold text-[#0F172A] shadow-2xl shadow-[#D4AF37]/30 transition-all hover:brightness-110 active:scale-95"
            >
